...
public class ReportService {
    ...
    // ✅ SIMPLE: Just save the report - controller handles assignment
    public Report createReport(Report report) {
        System.out.println("📝 SERVICE: Saving report...");
        System.out.println("   Category: " + report.getCategory());
        System.out.println("   Assigned to: " + (report.getAssignedTo() != null ? report.getAssignedTo().getName() : "null"));
        System.out.println("   Status: " + report.getStatus());
        
        // ✅ Just save - no extra logic
